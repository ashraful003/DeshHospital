...
import com.myapp.deshhospital.databinding.FragmentMedicineDetailsBinding
...
class MedicineDetailsFragment : Fragment() {
    val actionUpdateMedicineInfo = Navigation.createNavigateOnClickListener(R.id.action_medicineDetailsFragment_to_updateMedicineInfoFragment)
    @Inject
